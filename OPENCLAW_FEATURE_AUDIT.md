...
- Added CP5 starter parity fixtures in gateway tests for browser proxy success path and command-allowlist rejection, while preserving no-node unavailable behavior contract.
