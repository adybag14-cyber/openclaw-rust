...
- Added cron webhook delivery side-effects parity: `delivery.mode = webhook` now issues HTTP POST callbacks with structured run/job/payload envelopes during cron execution.
