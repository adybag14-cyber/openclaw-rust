...
tests=(
  ...
  "channels::tests::channel_message_action_aliases_parse"
  "channels::tests::channel_action_support_uses_channel_capabilities"
  "channels::tests::build_channel_transport_receipt_contains_adapter_and_route_metadata"
  ...
  "gateway::tests::dispatcher_send_method_follows_parity_contract"
  "gateway::tests::dispatcher_poll_method_follows_parity_contract"
